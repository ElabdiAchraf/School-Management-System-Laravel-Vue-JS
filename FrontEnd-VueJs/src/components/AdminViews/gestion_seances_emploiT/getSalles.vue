  ...
  <CCardBody>
    ...
    <div>
      <b-modal id="bv-modal-example2" hide-footer>
        <template #modal-title>Add Seance </template>
        <div class="d-block text-center">
    ...
    <b-jumbotron bg-variant="white">
      <template #header>Gestion Seances et Emploi du temps </template>
      <b-button pill variant="success" @click="Add">créer Seance</b-button>
      <hr class="my-4" />
      <CDataTable
        :items="items"
        :fields="fields"
