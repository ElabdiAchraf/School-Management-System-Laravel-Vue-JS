  ...
  <CCardBody>
    ...
    <div>
      <b-modal id="bv-modal-example3" hide-footer>
        <template #modal-title>Add prof </template>
        <div class="d-block text-center">
          <AddProf @refresh="refreshClasses" />
        </div>
    ...
    <b-jumbotron bg-variant="white">
      ...
      <b-button pill variant="success" @click="Add">créer Professeur</b-button>
      <hr class="my-4" />
...
import AddProf from "./addprof.vue";
export default {
  name: "AdvancedTables",
  data() {
    return {
